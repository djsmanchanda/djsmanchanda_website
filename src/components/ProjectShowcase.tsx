...
const projects: Project[] = [
  {
    ...
    live: "https://mumbairains.djsmanchanda.com",
  ...
  },
  {
    ...
    github: "https://github.com/djsmanchanda/GremlinBoard",
    status: "In active development",
  },
  {
    ...
    github: "https://github.com/djsmanchanda/Blue_Star_Smart_AC_control",
  },
  {
    ...
    github: "https://github.com/djsmanchanda/Samsung_Smart_Switch_Deduplicator",
  },
  {
    title: "Nacho Index",
    ...
    live: "https://nachos.djsmanchanda.com",
    github: "https://github.com/djsmanchanda/nacho_index",
  },
  {
    ...
    <section aria-labelledby="selected-work" className={styles.section}>
      ...
      <div className={styles.grid}>
        {projects.map((project) => (
          <article
            className={`${styles.card} ${project.comingSoon ? styles.comingSoonCard : ""}`}
            key={project.title}
            aria-label={project.comingSoon ? "Coming soon project" : undefined}
          >
            ...
            {(project.live || project.github) && (
              <div className={styles.links}>
                {project.live && (
                  <a className={styles.linkLabel} href={project.live} target="_blank" rel="noreferrer">
                    View project <span aria-hidden="true">↗</span>
                  </a>
                )}
                {project.github && (
                  <a className={styles.linkLabel} href={project.github} target="_blank" rel="noreferrer">
